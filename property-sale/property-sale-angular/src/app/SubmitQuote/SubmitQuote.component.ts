...
import { SubmitQuoteService } from './SubmitQuote.service';
import 'rxjs/add/operator/toPromise';

@Component({
  selector: 'app-submitquote',
  templateUrl: './SubmitQuote.component.html',
  styleUrls: ['./SubmitQuote.component.css'],
  providers: [SubmitQuoteService]
})
export class SubmitQuoteComponent implements OnInit {
  ...
  constructor(private serviceSubmitQuote: SubmitQuoteService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceSubmitQuote.getAll()
    .toPromise()
    .then((result) => {
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceSubmitQuote.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceSubmitQuote.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceSubmitQuote.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
